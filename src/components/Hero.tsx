...
export const Hero: React.FC<HeroProps> = ({ onRegisterClick, onExploreEventsClick }) => {
  return (
    <section
      id="home"
      className="relative min-h-screen flex flex-col justify-between pt-28 pb-12 overflow-hidden bg-black"
    >
      {/* Phoenix video layer — full background, no white overlay */}
      <PhoenixHeroGraphic />

      {/* Hero Content — white text on dark video background */}
      ...
      <div className="relative z-10 flex flex-col items-center justify-center pt-8">
        <a
          href="#about"
          className="group flex flex-col items-center gap-2 text-white/50 hover:text-phoenix-orange transition-colors duration-300"
        >
