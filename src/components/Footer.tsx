...
interface SocialLinkProps {
  ...
  accent?: string; // hover border/text color class
}

const SocialLink: React.FC<SocialLinkProps> = ({ href, title, children, accent = 'hover:border-phoenix-orange hover:text-phoenix-orange' }) => (
  <a
    href={href}
    target="_blank"
    rel="noreferrer"
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 pb-12 border-b border-white/10">
          ...
          <div className="md:col-span-5 space-y-5">
            ...
            <p className="text-sm text-neutral-400 font-medium leading-relaxed max-w-md">
              National Level Technical Symposium organized by the Department of Computer Science and Engineering,
              Adhiparasakthi Engineering College, in association with Computer Society of India – Kanchipuram Chapter.
            </p>
            ...
            <div>
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs text-neutral-500 font-medium">@pixelora_2k26</span>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="flex flex-wrap items-center gap-2">
                <SocialLink href="https://www.instagram.com/apec1984/" title="APEC Instagram" accent="hover:border-phoenix-magenta hover:text-phoenix-magenta">
                  <IconInstagram />
                </SocialLink>
                <SocialLink href="https://www.facebook.com/apec1984" title="APEC Facebook" accent="hover:border-blue-400 hover:text-blue-400">
                  <IconFacebook />
                </SocialLink>
                <SocialLink href="https://x.com/apec1984" title="APEC X (Twitter)" accent="hover:border-neutral-200 hover:text-white">
                  <IconX />
                </SocialLink>
                <SocialLink href="https://apec.edu.in" title="APEC Website" accent="hover:border-phoenix-orange hover:text-phoenix-orange">
                  <Globe className="w-4 h-4" />
                </SocialLink>
                <SocialLink href="mailto:cse@adhiparasakthi.in" title="Email CSE Dept" accent="hover:border-phoenix-orange hover:text-phoenix-orange">
                  <Mail className="w-4 h-4" />
                </SocialLink>
              </div>
              <div className="mt-2 flex flex-wrap gap-x-3 gap-y-1">
                <span className="text-[10px] text-neutral-500 font-medium">Instagram: /apec1984</span>
                <span className="text-[10px] text-neutral-500 font-medium">Facebook: /apec1984</span>
                <span className="text-[10px] text-neutral-500 font-medium">X: @apec1984</span>
              </div>
            </div>
          </div>
          ...
          <div className="md:col-span-3 space-y-3">
            <h4 className="text-[10px] font-bold tracking-widest text-neutral-500 uppercase">QUICK NAVIGATION</h4>
            <ul className="space-y-2 text-xs font-semibold tracking-wider text-neutral-400">
              {[
                ...
                <li key={link.label}>
                  {link.newTab ? (
                    <a href={link.href} target="_blank" rel="noreferrer" className="hover:text-phoenix-orange transition-colors flex items-center gap-1">
                      {link.label}
                    </a>
                  ) : (
                    <a href={link.href} className="hover:text-phoenix-orange transition-colors">{link.label}</a>
                  )}
                </li>
              ))}
            </ul>
          ...
          <div className="md:col-span-4 space-y-4">
            ...
            <p className="text-xs text-neutral-500 leading-relaxed">
              Secure your seat at the National Level Technical Symposium. Registration closes 13 October 2026 at 10:00 PM.
            </p>
            <button
              onClick={onRegisterClick}
              className="w-full phoenix-gradient-btn py-3 rounded-full text-white text-xs font-bold tracking-wider uppercase"
            >
              REGISTER NOW
            </button>
            ...
            <div className="pt-4 space-y-2">
              ...
              <p className="text-xs text-neutral-500">09:00 AM Onwards · Melmaruvathur</p>
            </div>
          </div>
        </div>
